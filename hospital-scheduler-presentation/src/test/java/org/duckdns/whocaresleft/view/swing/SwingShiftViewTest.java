    ...
    class UIEnablingAndDisabling {
        ...
        class OverallUI {
            ...
            void testShowAllShiftsShouldEnableUI() {
                ...
                window.textBox("startTimeTextBox").requireEnabled();
                window.button("startTimeButton").requireEnabled();
                window.textBox("endTimeTextBox").requireEnabled();
