...
class DoctorModelViewPresenterSwingMongoIT {
    ...
    @Nested @DisplayName("Integration from View's perspective")
    class IntegrationFromView {
    ...
    @Nested @DisplayName("Interaction of the whole MVP architecture")
    class MVPArchitectureInteraction {
